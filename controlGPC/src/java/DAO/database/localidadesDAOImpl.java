 ...
 * @author elara
 */
public class localidadesDAOImpl implements catalogosInterface {

    private Connection _conn;

    public localidadesDAOImpl(Connection _conn) {
        this._conn = _conn;
    }
    ...
    public boolean agregarRegistro(Object o) throws Exception {
        ...
        Localidades _localidadesObj = (Localidades) o;
    ...
    public Object consultarTodos() throws Exception {
        ...
        Localidades _localidadesObj;

        List<Localidades> _listaLocalidades = new ArrayList();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                _localidadesObj = new Localidades();
                ...
                _listaLocalidades.add(_localidadesObj);
            }
    ...
    public Object consultarPorId(int id) throws Exception {
        ...
        Localidades _localidadesObj = new Localidades();
