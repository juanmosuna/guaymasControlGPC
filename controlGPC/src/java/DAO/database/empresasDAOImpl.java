 ...
 * @author elara
 */
public class empresasDAOImpl implements catalogosInterface {

    private Connection _conn;

    public empresasDAOImpl(Connection _conn) {
        this._conn = _conn;
    }
    ...
    public boolean agregarRegistro(Object o) throws Exception {
        ...
        Empresas _empresasObj = (Empresas) o;
    ...
    public Object consultarTodos() throws Exception {
        ...
        Empresas _empresasObj;

        List<Empresas> _listaEmpresas = new ArrayList();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                _listaEmpresas.add(_empresasObj);
            }
    ...
    public Object consultarPorId(int id) throws Exception {
        ...
        Empresas _empresasObj = new Empresas();
