...
import entities.TipoDocumentos;
 ...
 * @author elara
 */
public class tipoDocumentosDAOImpl implements catalogosInterface {
    
    private Connection _conn;

    public tipoDocumentosDAOImpl(Connection _conn) {
        this._conn = _conn;
    }
    ...
    public boolean agregarRegistro(Object o) throws Exception {
        ...
        TipoDocumentos _tpDocumentosObj = (TipoDocumentos) o;
    ...
    public Object consultarTodos() throws Exception {
        ...
        TipoDocumentos _tpDocumentosObj;

        List<TipoDocumentos> _listatpDocumentos = new ArrayList();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                _tpDocumentosObj = new TipoDocumentos();
    ...
    public Object consultarPorId(int id) throws Exception {
        ...
        TipoDocumentos _tpDocumentosObj = new TipoDocumentos();
