...
public class contactoCliente {
    ...
    public byte[] getFotoContactoCliente() {
        return fotoContactoCliente;
    }

    public void setFotoContactoCliente(byte[] fotoContactoCliente) {
        this.fotoContactoCliente = fotoContactoCliente;
    }
