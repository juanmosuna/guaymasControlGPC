...
public class transportista {
    ...
    private byte[] fotoTransportista = null;
    ...
    public byte[] getFotoTransportista() {
        return fotoTransportista;
    }

    public void setFotoTransportista(byte[] fotoTransportista) {
        this.fotoTransportista = fotoTransportista;
    }
