...
import DAO.database.localidadDAOImpl;
 ...
 * @author elara
 */
@WebServlet(name = "localidadServlet", urlPatterns = {"/localidadServlet.do"})
        ...
        try {
            ...
            switch (_opcion) {
                case 1: {
                    ...
                    localidad _localidadObj = new localidad();

                    _localidadObj.setNombreCompleto(_nombreCompleto);
                    _localidadObj.setDescripcion(_descripcion);
