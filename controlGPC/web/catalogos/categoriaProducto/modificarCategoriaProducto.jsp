<%-- 
    Document   : modificarCategoriaProductos
...
<%
    if (session.getAttribute("usuario") == null){
        ...
        if (request.getParameter("id") != null){
            ...
            categoriaProducto _categoriaProducto = new categoriaProducto();
            
            try{
                
                categoriaProductoDAOImpl _categoriaProductoDAO = new categoriaProductoDAOImpl(_baseDatos.getConnection());
                
                _categoriaProducto = (categoriaProducto) _categoriaProductoDAO.consultarPorId(_id);
...
<html>
    <head>
        ...
        <title>Modificar categoría del producto</title>
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Modificar categorias de productos</h1>
            ...
            <form id="formulario" action="/controlGPC/categoriaProductoServlet.do" method="post" class="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="nombreCompleto" name="nombreCompleto" placeholder="Teclee el nombre completo de la categoría del producto ..." value="<%=_categoriaProducto.getNombreCompleto() %>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Teclee una descripción acerca de la categoría del producto ..." value="<%=_categoriaProducto.getDescripcion() %>" required>
...
<%
            ...
            String _mensajeAlerta = "danger, No se encontró la categoría del producto ...";
            response.sendRedirect("/controlGPC/catalogos/categoriaProducto/categoriaProductoTabla.jsp?m=" + _mensajeAlerta);
        }
    }  
%>