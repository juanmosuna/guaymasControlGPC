<%-- 
    Document   : categoriaProductoTabla
...
<html>
    <head>
        ...
        <title>Catálogo de categorías de productos</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarCategoriaProducto.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_categoriaProducto.getId() %></td>
                            <td><%=_categoriaProducto.getNombreCompleto() %></td>
                            <td><%=_categoriaProducto.getDescripcion() %></td>
                            <td width="10"><a href="modificarCategoriaProducto.jsp?id=<%=_categoriaProducto.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/categoriaProductoServlet.do?op=3&id=<%=_categoriaProducto.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
