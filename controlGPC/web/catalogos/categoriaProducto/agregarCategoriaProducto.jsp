        ...
        <div class="container">
            ...
            <form action="" method="post" class="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="nombreCompleto" placeholder="Teclee el nombre completo de la categoría del producto ..." required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descripcion" placeholder="Teclee una descripción acerca de la categoría del producto ..." required>
