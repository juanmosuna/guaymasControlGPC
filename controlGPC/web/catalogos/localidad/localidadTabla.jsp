...
<html>
    <head>
        ...
        <title>Catálogo de localidades</title>
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Localidades</h1>
                    <i class="fas fa-globe fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarLocalidad.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_localidad.getId() %></td>
                            <td><%=_localidad.getNombreCompleto() %></td>
                            <td><%=_localidad.getDescripcion() %></td>
                            <td width="10"><a href="modificarLocalidad.jsp?id=<%=_localidad.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/localidadServlet.do?op=3&id=<%=_localidad.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
