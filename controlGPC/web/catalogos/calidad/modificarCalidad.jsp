...
<%
    if (session.getAttribute("usuario") == null){
        ...
        if (request.getParameter("id") != null){
            ...
            calidad _calidad = new calidad();
            
            try{
                
                calidadDAOImpl _calidadDAO = new calidadDAOImpl(_baseDatos.getConnection());
                
                _calidad = (calidad) _calidadDAO.consultarPorId(_id);
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Modificar calidad</h1>
            ...
            <form id="formulario" action="/controlGPC/calidadServlet.do" method="post" class="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="nombreCompleto" name="nombreCompleto" placeholder="Teclee el nombre completo de la calidad ..." value="<%=_calidad.getNombreCompleto() %>"  required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="codigo" name="codigo" placeholder="Teclee el código de la calidad ..." value="<%=_calidad.getCodigo() %>" required>
                    <div class="invalid-feedback">
                     Campo obligatorio!    
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Teclee una descripción acerca de la calidad ..." value="<%=_calidad.getDescripcion() %>">
                </div>
                <div class="form-group">
                    ...
                    <select class="custom-select mr-sm-2" id="grupoCalidad" name="idgrupoCalidad">
                        <option value="0">Selecciona un grupo de calidad ...</option>
                        <%
                            ...
                            for(grupoCalidad _grupoCalidad : _grupoCalidadDAO){
                                out.print("<option value=\""+_grupoCalidad.getId()+"\" " + ( _grupoCalidad.getId() == _calidad.getGrpCalidad().getId() ? "selected" : "") + ">"+_grupoCalidad.getNombreCompleto()+"</option>");
                            }
                        %>
                    </select>
                </div>
...
<%
            ...
            String _mensajeAlerta = "danger, No se encontró la calidad ...";
            response.sendRedirect("/controlGPC/catalogos/calidad/calidadTabla.jsp?m=" + _mensajeAlerta);
        }
    }  
%>