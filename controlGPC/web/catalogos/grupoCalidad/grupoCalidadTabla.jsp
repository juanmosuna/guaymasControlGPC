...
<html>
    <head>
        ...
        <title>Catálogo de grupos de calidades</title>
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Grupo de calidades</h1>
                    <i class="fas fa-clipboard-check fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
                <li><a href="../catalogos.jsp">Catálogos</a> <span class="divider">/</span></li>
                <li class="active">Grupo de calidades</li>
            </ul>
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarGrupoCalidad.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_grupoCalidad.getId() %></td>
                            <td><%=_grupoCalidad.getNombreCompleto() %></td>
                            <td><%=_grupoCalidad.getDescripcion() %></td>
                            <td width="10"><a href="modificarGrupoCalidad.jsp?id=<%=_grupoCalidad.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/grupoCalidadServlet.do?op=3&id=<%=_grupoCalidad.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
