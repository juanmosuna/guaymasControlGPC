        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Tipo de vehículos</h1>
                    <i class="fas fa-truck-loading fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_tipoVehiculo.getId() %></td>
                            <td><%=_tipoVehiculo.getNombreCompleto() %></td>
                            <td><%=_tipoVehiculo.getDescripcion() %></td>
                            <td width="10"><a href="modificarTipoVehiculo.jsp?id=<%=_tipoVehiculo.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/tipoVehiculoServlet.do?op=3&id=<%=_tipoVehiculo.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
