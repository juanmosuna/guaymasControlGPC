        ...
        <div class="container">
            ...
            <form id="formulario" action="/controlGPC/empresaServlet.do" method="post" class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Teclee una descripción acerca de la empresa ..." value="<%=_empresa.getDescripcion() %>" required>
                </div>
                <div class="form-group">
...
<%
            ...
            String _mensajeAlerta = "danger, No se encontró la empresa ...";
