    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarDepartamento.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_departamento.getId() %></td>
                            <td><%=_departamento.getNombreCompleto() %></td>
                            <td><%=_departamento.getDescripcion() %></td>
                            <td width="10"><a href="modificarDepartamento.jsp?id=<%=_departamento.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/departamentoServlet.do?op=3&id=<%=_departamento.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
