...
<html>
    <head>
        ...
        <title>Catálogo de unidades de medidas</title>
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Unidad de medidas</h1>
                    <i class="fas fa-ruler fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarUnidadMedida.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_unidadMedida.getId() %></td>
                            <td><%=_unidadMedida.getCodigo() %></td>
                            <td><%=_unidadMedida.getNombreCompleto() %></td>
                            <td><%=_unidadMedida.getDescripcion() %></td>
                            <td width="10"><a href="modificarUnidadMedida.jsp?id=<%=_unidadMedida.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/unidadMedidaServlet.do?op=3&id=<%=_unidadMedida.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
