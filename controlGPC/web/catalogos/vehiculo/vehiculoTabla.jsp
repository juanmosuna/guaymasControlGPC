        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Vehículos</h1>
                    <i class="fas fa-truck fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarVehiculo.jsp" class="btn btn-primary">+ Agregar</a>
                ...
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            List<vehiculo> _vehiculoDAO = new ArrayList<vehiculo>();
                                
                            try{
                            
                                vehiculoDAOImpl _vehiculoDAOImpl = new vehiculoDAOImpl(_baseDatos.getConnection());
                                
                                _vehiculoDAO = (List<vehiculo>)_vehiculoDAOImpl.consultarTodos();
                            ...
                            for(vehiculo _vehiculo : _vehiculoDAO){
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_vehiculo.getId() %></td>
