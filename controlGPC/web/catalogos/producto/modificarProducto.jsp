    ...
    if (session.getAttribute("usuario") == null){
        ...
        if (request.getParameter("id") != null){
            ...
            try{
                ...
                _producto = (producto) _productoDAO.consultarPorId(_id);
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Modificar producto</h1>
            ...
            <form id="formulario" action="/controlGPC/productoServlet.do" method="post" class="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="nombreCompleto" name="nombreCompleto" placeholder="Teclee el nombre completo del producto ..." value="<%=_producto.getNombreCompleto() %>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-invalid" id="codigo" name="codigo" placeholder="Teclee un código para éste producto ..." value="<%=_producto.getCodigo() %>" required>
                    <div class="invalid-feedback">
                     Campo obligatorio!    
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Teclee una descripción acerca del producto ..." value="<%=_producto.getDescripcion() %>" required>
                </div>
                <div class="form-group">
                    ...
                    <select class="custom-select mr-sm-2" id="idCategoriaProducto" name="idCategoriaProducto">
                        ...
                        <%
                            ...
                            for(categoriaProducto _categoriaProducto : _categoriaProductoDAO){
                                out.print("<option value=\""+_categoriaProducto.getId()+"\" " + ( _categoriaProducto.getId() == _producto.getCtgProducto().getId()  ? "selected" : "") + ">"+_categoriaProducto.getNombreCompleto()+"</option>");
                            }
                        %>
...
<%
            ...
            String _mensajeAlerta = "danger, No se encontró el producto ...";
            response.sendRedirect("/controlGPC/catalogos/producto/productoTabla.jsp?m=" + _mensajeAlerta);
        }
    }  
%>