...
<html>
    <head>
        ...
        <title>Catálogo de transportistas</title>
        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Transportistas</h1>
                    <i class="fas  fa-truck-moving fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarTransportista.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_transportista.getId() %></td>
                            <td><%=_transportista.getNombreCompleto() %></td>
                            <td><%=_transportista.getDescripcion() %></td>
                            <td width="10"><a href="modificarTransportista.jsp?id=<%=_transportista.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/transportistaServlet.do?op=3&id=<%=_transportista.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
