        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Tipo de movimientos</h1>
                    <i class="fas fa-exchange-alt fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_tipoMovimiento.getId() %></td>
                            <td><%=_tipoMovimiento.getNombreCompleto() %></td>
                            <td><%=_tipoMovimiento.getDescripcion() %></td>
                            <td width="10"><a href="modificarTipoMovimiento.jsp?id=<%=_tipoMovimiento.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/tipoMovimientoServlet.do?op=3&id=<%=_tipoMovimiento.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
