        ...
        <div class="container">
            <div class="card-group">
                <div class="card-body d-flex justify-content-between">
                    <h1 class="card-title fontUbuntulight fontColor ">Clientes</h1>
                    <i class="fas fa-user-tie fa-4x iconColor"></i>
                </div>
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="agregarCliente.jsp" class="btn btn-primary">+ Agregar</a>
            ...
            <div class="container">
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td width="40" scope="row"><%=_cliente.getId() %></td>
                            <td><%=_cliente.getNombreCompleto() %></td>
                            <td><%=_cliente.getDescripcion() %></td>
                            <td width="10"><a href="modificarCliente.jsp?id=<%=_cliente.getId() %>"><i class="fa fa-pencil-alt text-primary"></i></a></td>
                            <td width="10"><a href="/controlGPC/clienteServlet.do?op=3&id=<%=_cliente.getId() %>"><i class="fa fa-trash-alt  text-danger"></i></a></td>
                        </tr>
                        <%
                            }
                        %>
